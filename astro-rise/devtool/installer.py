...
WORLD_SERVER_DIR = os.path.join(SERVER_DIR, "world")
...
DEFAULTCONFIG_SOURCE_DIR = os.path.join(ASTRO_RISE_SRC_DIR, "defaultconfigs")
KUBEJS_SOURCE_DIR = os.path.join(ASTRO_RISE_SRC_DIR, "kubejs")
MODS_SOURCE_DIR = os.path.join(ASTRO_RISE_SRC_DIR, "mods")
SHADERS_SOURCE_DIR = os.path.join(ASTRO_RISE_SRC_DIR, "shaderpacks")
RUN_SERVER_SCRIPT_SOURCE_PATH = os.path.join(ASTRO_RISE_DIR, "devtool", "run-server.sh")
PATCH_KUBEJS_SCRIPT_SOURCE_PATH = os.path.join(ASTRO_RISE_DIR, "devtool", "patch-kubejs.sh")
...
def install_client():
    ...
    sync_directory(DEFAULTCONFIG_SOURCE_DIR, os.path.join(MINECRAFT_DIR, 'defaultconfigs'))
    sync_directory(KUBEJS_SOURCE_DIR, os.path.join(MINECRAFT_DIR, 'kubejs'))
    sync_directory(SHADERS_SOURCE_DIR, os.path.join(MINECRAFT_DIR, 'shaderpacks'))
    sync_mods()
...
def install_server():
    ...
    sync_directory(DEFAULTCONFIG_SOURCE_DIR, os.path.join(WORLD_SERVER_DIR, 'defaultconfigs'))
