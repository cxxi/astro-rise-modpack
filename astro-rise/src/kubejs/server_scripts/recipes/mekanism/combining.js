ServerEvents.recipes(event => {
	...
	event.recipes.mekanismCombining('simplemetals_aluminum:aluminum_ore', Item.of('simplemetals_aluminum:raw_aluminum', 8), 'minecraft:cobblestone')
	event.recipes.mekanismCombining('simplemetals_aluminum:deepslate_aluminum_ore', Item.of('simplemetals_aluminum:raw_aluminum', 8), 'minecraft:cobbled_deepslate')
	event.recipes.mekanismCombining('platinum_mod:platinum_ore', Item.of('platinum_mod:raw_platinum', 8), 'minecraft:cobblestone')
	event.recipes.mekanismCombining('platinum_mod:deepslate_platinum_ore', Item.of('platinum_mod:raw_platinum', 8), 'minecraft:cobbled_deepslate')
