ServerEvents.recipes(event => {
	...
	event.recipes.mekanismCombining('simplemetals_aluminum:aluminum_ore', Item.of('astro_rise:dust_aluminum', 5), 'minecraft:cobblestone')
	event.recipes.mekanismCombining('simplemetals_aluminum:deepslate_aluminum_ore', Item.of('astro_rise:dust_aluminum', 5), 'minecraft:cobbled_deepslate')
	event.recipes.mekanismCombining('platinum_mod:platinum_ore', Item.of('astro_rise:dust_platinum', 5), 'minecraft:cobblestone')
	event.recipes.mekanismCombining('platinum_mod:deepslate_platinum_ore', Item.of('astro_rise:dust_platinum', 5), 'minecraft:cobbled_deepslate')
